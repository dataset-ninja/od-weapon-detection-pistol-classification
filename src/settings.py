...
SLYTAGSPLIT: Optional[Dict[str, Union[List[str], str]]] = {"__POSTTEXT__":"The dataset designed for classification task, contains 102 classes: ***aaapistol***, ***pizza***, ***joshua_tree*** and more"}
